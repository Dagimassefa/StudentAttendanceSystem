...
<body>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                     <form class="form-material" action="{{ route('register.student') }}" method="POST">
    @csrf
    ...
    <div class="text-right">
        <button type="submit" class="btn btn-primary btn-round waves-effect waves-light">Register Student</button>
    </div>
</form>
 @isset($qrCode)
